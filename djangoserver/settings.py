...
SECRET_KEY = 'django-insecure-gl^)hz8nb1oq47nmamf*9zo8ja&8z5=9ljg@y-9@6_j2euhj_-'
...
REST_FRAMEWORK = {
    'DEFAULT_RENDER_CLASSES': [
        ...
        # если не хотим юзать api встроенное а использовать браузер чисто для запросов
    ],
